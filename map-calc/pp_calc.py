...
def pp_calc(aim, speed, b, length_bonus, speed_length, misses, c100, c50, used_mods=mods(), combo=0xFFFF, score_version=1, c300=0xFFFF):
    res = pp_calc_result()
    od = b.od
    ar = b.ar
    ...
    return res, aim_value, speed_value, acc_value, old_length_bonus, length_bonus, 0
